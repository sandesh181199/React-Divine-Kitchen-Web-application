...
export const postUser = (username,password,firstname,lastname) => (dispatch) => {
   // dispatch(requestSignin({username,password,firstname,lastname}))
   console.log("inside signinUser actioncreator")
   const newUser = {
       username : username,
       password : password,
       firstname : firstname,
...
export const deleteDish = (dishId) => (dispatch) =>{
    ...
    .then(response => response.json())
    .then(dish => { console.log('Dish Deleted', dish);})
    .catch(error => dispatch(dishesFailed(error.message)))
}

export const editDish = (dishId, value) => (dispatch) => {
    console.log(value)
    const bearer = 'Bearer ' + localStorage.getItem('token');
    ...
    .then(response => response.json())
    .then(dish => { console.log('Dish edited', dish); dispatch(fetchDishes())})
    .catch(error => dispatch(dishesFailed(error.message)))
}

export const deleteAllDishes = () => (dispatch) => {
    const bearer = 'Bearer ' + localStorage.getItem('token');
    ...
    .then(response => response.json())
    .then(dish => { console.log('Dishes Deleted', dish);})
    .catch(error => dispatch(dishesFailed(error.message)))

}

export const addNewDish = (value) => (dispatch)=> {
    const bearer = 'Bearer ' + localStorage.getItem('token');
    ...
    .then(response => response.json())
    .then(dish => console.log("dish added " +dish))
    .catch(error => dispatch(dishesFailed(error.message)))

}

export const newDish = (dish) => ({
     type: ActionTypes.NEW_DISH,
    payload : dish
})
...
export const uploadImage = (fileName) => (dispatch) => {
    ...
    .then(response => response.json())
    .then(img => { console.log('Image added ', img);})
    .catch(error => dispatch(dishesFailed(error.message)))
